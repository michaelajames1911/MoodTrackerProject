emotions_dict = {
    ...
    "HighEnergy_pleasant": {
        ...
        "productive": "feeling like you are accomplishing your tasks or achieving your goals"
    },
  
    "HighEnergy_unpleasant": {
    ...
    "LowEnergy_unpleasant": {
        ...
        "disengaged": "feeling like you cannot focus or are disinterested"
    }
}